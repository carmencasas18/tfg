...
int main() {
    std::vector<Drone> drones;
    drones.push_back({0, 39.140541, -5.044044, {}});
    drones.push_back({1, 39.139341, -5.062368, {}});
    drones.push_back({2, 39.146132, -5.035888, {}});
    drones.push_back({3, 39.123670, -5.074702, {}});
    drones.push_back({4, 39.153288, -5.055550, {}});
    drones.push_back({5, 39.163104, -5.052651, {}});
    drones.push_back({6, 39.130504, -5.071467, {}});
    drones.push_back({7, 39.144213, -5.043655, {}});
    drones.push_back({8, 39.144052, -5.061345, {}});
    drones.push_back({9, 39.127404, -5.075540, {}});
    drones.push_back({10, 39.136716, -5.037387, {}});
    drones.push_back({11, 39.148865, -5.063997, {}});
    drones.push_back({12, 39.161147, -5.064975, {}});
    drones.push_back({13, 39.152483, -5.043278, {}});
    drones.push_back({14, 39.126946, -5.061464, {}});
    drones.push_back({15, 39.131331, -5.047550, {}});
    drones.push_back({16, 39.129892, -5.070432, {}});
    drones.push_back({17, 39.137108, -5.063126, {}});
    drones.push_back({18, 39.137102, -5.073709, {}});
    drones.push_back({19, 39.164013, -5.064702, {}});
    drones.push_back({20, 39.420234, -5.198911, {}});
    drones.push_back({21, 39.424938, -5.230796, {}});
    drones.push_back({22, 39.427651, -5.197333, {}});
    drones.push_back({23, 39.401693, -5.224458, {}});
    drones.push_back({24, 39.430736, -5.198011, {}});
    drones.push_back({25, 39.418091, -5.195653, {}});
    drones.push_back({26, 39.384337, -5.207041, {}});
    drones.push_back({27, 39.392544, -5.223982, {}});
    drones.push_back({28, 39.430485, -5.226711, {}});
    drones.push_back({29, 39.414754, -5.231186, {}});
    drones.push_back({30, 39.402357, -5.188906, {}});
    drones.push_back({31, 39.420460, -5.185099, {}});
    drones.push_back({32, 39.396958, -5.196021, {}});
    drones.push_back({33, 39.423547, -5.208701, {}});
    drones.push_back({34, 39.429083, -5.211725, {}});
    drones.push_back({35, 39.409330, -5.202039, {}});
    drones.push_back({36, 39.392554, -5.210346, {}});
    drones.push_back({37, 39.406339, -5.220323, {}});
    drones.push_back({38, 39.407248, -5.209131, {}});
    drones.push_back({39, 39.399151, -5.201758, {}});
    drones.push_back({40, 39.186421, -4.931518, {}});
    drones.push_back({41, 39.187478, -4.901687, {}});
    drones.push_back({42, 39.213956, -4.897520, {}});
    drones.push_back({43, 39.211637, -4.932016, {}});
    drones.push_back({44, 39.197570, -4.921276, {}});
    drones.push_back({45, 39.190682, -4.903182, {}});
    drones.push_back({46, 39.232220, -4.910652, {}});
    drones.push_back({47, 39.200645, -4.930468, {}});
    drones.push_back({48, 39.203775, -4.921350, {}});
    drones.push_back({49, 39.220007, -4.890005, {}});
    drones.push_back({50, 39.220549, -4.925176, {}});
    drones.push_back({51, 39.185061, -4.898217, {}});
    drones.push_back({52, 39.197318, -4.929038, {}});
    drones.push_back({53, 39.227316, -4.892341, {}});
    drones.push_back({54, 39.188118, -4.892318, {}});
    drones.push_back({55, 39.207323, -4.904825, {}});
    drones.push_back({56, 39.200970, -4.922033, {}});
    drones.push_back({57, 39.225550, -4.927935, {}});
    drones.push_back({58, 39.226638, -4.886361, {}});
    drones.push_back({59, 39.195516, -4.904895, {}});

    drones.push_back({60, 39.27584, -5.08793, {}});
    drones.push_back({61, 39.26717, -5.08141, {}});
    drones.push_back({62, 39.24776, -5.07420, {}});
    drones.push_back({63, 39.23474, -5.07214, {}});
    drones.push_back({64, 39.22729, -5.07214, {}});
    drones.push_back({65, 39.21692, -5.07008, {}});
    drones.push_back({66, 39.20282, -5.06459, {}});
    drones.push_back({67, 39.1975, -5.05326, {}});
    drones.push_back({68, 39.18792, -5.0615, {}});
    drones.push_back({69, 39.17912, -5.05534, {}});
    drones.push_back({70, 39.16678, -5.04084, {}});
    drones.push_back({71, 39.16571, -5.0314, {}});
    drones.push_back({72, 39.16385, -5.02024, {}});
    drones.push_back({73, 39.16079, -5.00977, {}});
    drones.push_back({74, 39.15826, -5.00102, {}});
    drones.push_back({75, 39.15134, -4.9902, {}});
    drones.push_back({76, 39.14641, -4.98196, {}});
    drones.push_back({77, 39.14063, -4.97461, {}});
    drones.push_back({78, 39.13251, -4.96225, {}});
    drones.push_back({79, 39.12904, -4.95349, {}});
    drones.push_back({80, 39.13916, -4.94471, {}});
    drones.push_back({81, 39.14182, -4.95124, {}});
    drones.push_back({82, 39.14751, -4.9552, {}});
    drones.push_back({83, 39.15417, -4.96052, {}});
    drones.push_back({84, 39.15923, -4.96619, {}});
    drones.push_back({85, 39.16508, -4.97151, {}});
    drones.push_back({86, 39.17001, -4.98129, {}});
    drones.push_back({87, 39.17413, -4.98902, {}});
    drones.push_back({88, 39.17932, -4.99709, {}});
    drones.push_back({89, 39.18784, -5.00653, {}});
    drones.push_back({90, 39.20008, -5.01592, {}});
    drones.push_back({91, 39.21631, -5.02622, {}});
    drones.push_back({92, 39.22775, -5.03137, {}});
    drones.push_back({93, 39.24078, -5.03858, {}});
    drones.push_back({94, 39.25487, -5.04442, {}});
    drones.push_back({95, 39.26736, -5.04957, {}});
    drones.push_back({96, 39.27773, -5.05678, {}});
    drones.push_back({97, 39.28809, -5.06605, {}});
    drones.push_back({98, 39.29739, -5.07772, {}});
    drones.push_back({99, 39.21498, -5.06518, {}});
